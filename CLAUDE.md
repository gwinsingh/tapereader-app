...
- **66 columns**: Auto-filled trade data, formula columns (Stop after Avg Exit), manual per-trade + daily, enrichment + formula analysis columns (Max R Before Stop, Farthest Price, MAE (R), 1R-6R), market data enrichment, psych check-in columns.
