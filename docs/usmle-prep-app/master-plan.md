...
- [ ] Flashcards next wave: **images on cards** (storage decision: Cloudflare R2 vs Drive) → then daily new-card pacing, review stats+streak, leech detection, undo-rating, bulk browser actions, AI "explain card", card↔note links.
